...
- Keywords: `${{`, `github.event`, `pull_request_target`, `workflow_dispatch`, `secrets.`, `GITHUB_TOKEN`, `permissions:`, `uses:`, `actions/`, `run:`, `env:`, `with:`, `self-hosted`, `artifact`, `upload-artifact`, `download-artifact`, `deploy`, `publish`
